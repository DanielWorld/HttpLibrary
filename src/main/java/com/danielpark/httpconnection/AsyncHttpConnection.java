...
public class AsyncHttpConnection {
	...
	/**
	 * Start Async HTTP connection with {@link PureJsonHttpResponseHandler}
	 * @param request
	 * @param mListener
     */
	 ...
	 * @param mListener
	 */
	public void start(final HttpRequest request, PureJsonHttpResponseHandler mListener, Interceptor interceptor){
