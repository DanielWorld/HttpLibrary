...
public interface ResponseHandlerInterface {
     ...
     */
    void sendSuccessMessage(int statusCode, Headers headers, byte[] responseBody);
     ...
     */
    void sendFailureMessage(int statusCode, Headers headers, byte[] responseBody, Throwable error);
     ...
     */
    void setRequestHeaders(Headers requestHeaders);
     ...
     */
    void onPreProcessResponse(ResponseHandlerInterface instance, Response response);
     ...
     */
    void onPostProcessResponse(ResponseHandlerInterface instance, Response response);
